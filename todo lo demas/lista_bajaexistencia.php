	...
	<div class="card"> 
    	<div class="card-header bg-azul text-white ">
      		<div class="d-sm-flex align-items-center justify-content-between mb-2">
        		<h1 class="h6 mb-0 text-uppercase">Lista Medicamentos con baja Existencia</h1>        		
				<a href="index.php" class="btn btn-danger btn-sm"><i class="fas fa-arrow-left mr-1"></i>Volver</a>									
      		</div>
			<div class="d-sm-flex align-items-center mb-2"> 			  				
			  	<a id="printbe" name="printbe" class="btn btn-info btn-sm mr-2 pl-4 pr-2"><i class="fas fa-print mr-2"></i>Imprimir</a>	     
				<a id="printbec" name="printbec" class="btn btn-danger btn-sm mr-2 pl-4 pr-2"><i class="fas fa-arrow-left mr-2"></i>Cancelar</a> 		     		
				<a id="printbel" name="printbel" href="#" class="btn btn-secondary btn-sm mr-2 pl-4 pr-2"><i class="fas fa-print mr-2"></i>x Laboratorio</a>	
				<div id="labprntbel" name="labprntbel" class="col-2">                      
							...
							<select id="prov" name="prov" class="form-control form-control-sm">
								<option value="0" >Seleccoinar...</option>
								<?php
								if ($resultado_prov > 0) {
