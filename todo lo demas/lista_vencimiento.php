	...
	<div class="card"> 
    	<div class="card-header bg-azul text-white ">
      		<div class="d-sm-flex align-items-center justify-content-between mb-2">
        		<h1 class="h6 mb-0 text-uppercase">Medicamentos con Fecha de Vencimiento Cercana</h1>        		
			  ...
			  <div class="d-sm-flex align-items-center mb-2"> 			  			
				...
				<a id="printbel" name="printbel" href="#" class="btn btn-secondary btn-sm mr-2 pl-4 pr-4"><i class="fas fa-print mr-2"></i>x Laboratorio</a>	
				...
				<table class="table table-striped table-sm table-bordered" id="table">
					<thead class="thead-dark">
						<tr class="text-center aligin-middle" style="font-size:12px;">
							...
							<th width="70px">DÍAS FALTANTES</th>
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT s.idmedicamento AS id, s.saldo, s.fechavencimiento, s.idsuc,
																m.cantidadminima, m.nombre, m.laboratorio, m.concentracion,
																...
																WHERE WEEK(s.fechavencimiento) = WEEK(CURRENT_DATE)
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) {
								...
								$fechaven = $data['fechavencimiento'];
								$diaactual = date('d');
								$diavencimiento = date_format(date_create_from_format('Y-m-d',$fechaven), 'd');								
								$data['diasrestantes'] =  $diavencimiento - $diaactual;

								?>
								
								<tr class="aligin-middle" style="font-size:14px;">
									<td class="text-center" width="30px" class="text-center"><?php echo $data['id']; ?></td>
									<td width="350px"><?php echo $data['nombrecompleto']; ?></td>
									<td class="text-center" width="100px"><?php echo $data['fechavencimiento']; ?></td>
									<td class="text-center" width="100px"><?php echo $data['lab']; ?></td>
									<td class="text-center" width="70px"><?php echo $data['diasrestantes']; ?></td>
